...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        ...
        output : return boolean value based on validation results
    ...
    def is_column_exists(self, df: DataFrame) -> bool:
        """
        Method Name :   is_column_exists
        Description :   This method validates if the required column exists in the dataframe
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        Description :   This method initiates data validation process
